...
# 对话默认也优先速度,更适合黑客松现场演示;若更看重文风可手动切回 Opus
CHAT_MODEL = _env("MEALMATE_CHAT_MODEL", "claude-haiku-4-5-20251001")
# 偏好抽取:也是结构化小任务,用快模型
...
# 黑客松演示更怕"没反应",默认超时和重试都收紧,尽快给用户反馈。
REQUEST_TIMEOUT = float(_env("MEALMATE_TIMEOUT", "12"))          # 秒
LLM_RETRIES = int(_env("MEALMATE_LLM_RETRIES", "1"))             # 网络抖动时的额外重试次数
